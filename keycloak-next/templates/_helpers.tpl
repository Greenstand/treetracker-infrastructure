...
{{/*
Return the secret key that contains the Keycloak admin username
*/}}
{{- define "keycloak.secretUserKey" -}}
{{- if and .Values.auth.existingSecret .Values.auth.adminUserKey -}}
    {{- tpl .Values.auth.adminUserKey . -}}
{{- else -}}
    {{- print "admin" -}}
{{- end -}}
{{- end -}}
...
{{/*
Return the Database URL key that contains the database URL
*/}}
{{- define "keycloak.database.secretURLKey" -}}
{{- default "db-host" .Values.externalDatabase.existingSecretURLKey -}}
{{- end -}}
