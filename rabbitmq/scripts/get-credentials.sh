kubectl get rabbitmqcluster  rabbitmqcluster-main \
...
kubectl get secret rabbitmqcluster-main-default-user -o jsonpath="{.data.username}" | base64 --decode
echo  ""
echo  -n "password "
kubectl get secret rabbitmqcluster-main-default-user -o jsonpath="{.data.password}" | base64 --decode
echo  ""
