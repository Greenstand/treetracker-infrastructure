resource "digitalocean_droplet" "monitor" {
  ...
  name   = "prom-graf"
  region = var.do_region # "sfo2"
  size   = "s-2vcpu-2gb"
  ssh_keys = var.ssh_key_fingerprint # ["37:45:4a:cd:5e:72:46:48:8f:69:e9:98:4f:6e:27:e0"] # SSH keys that need to be installed on the server.
  tags = ["monitoring"]
}
